...
CREATE TABLE "delivery_order_items" (
	...
	"line_total_sen" integer DEFAULT 0 NOT NULL,
	"line_no" integer,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL
);
...
CREATE TABLE "delivery_return_items" (
	...
	"condition" text,
	"unit_price_sen" integer DEFAULT 0 NOT NULL,
	"refund_sen" integer DEFAULT 0 NOT NULL,
	"notes" text,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL
);
...
CREATE TABLE "fabric_trackings" (
	...
	"soh_sen" integer DEFAULT 0 NOT NULL,
	"po_outstanding_sen" integer DEFAULT 0 NOT NULL,
	"last_month_usage_sen" integer DEFAULT 0 NOT NULL,
	"one_week_usage_sen" integer DEFAULT 0 NOT NULL,
	"two_weeks_usage_sen" integer DEFAULT 0 NOT NULL,
	"one_month_usage_sen" integer DEFAULT 0 NOT NULL,
	"shortage_sen" integer DEFAULT 0 NOT NULL,
	"reorder_point_sen" integer DEFAULT 0 NOT NULL,
	"supplier" text,
	"supplier_code" text,
...
CREATE TABLE "fabrics" (
	...
	"category" text,
	"price_sen" integer DEFAULT 0 NOT NULL,
	"soh_meters_sen" integer DEFAULT 0 NOT NULL,
	"reorder_level_sen" integer DEFAULT 0 NOT NULL,
...
CREATE TABLE "grns" (
	...
	"subtotal_sen" integer DEFAULT 0 NOT NULL,
	"tax_sen" integer DEFAULT 0 NOT NULL,
	"total_sen" integer DEFAULT 0 NOT NULL,
...
CREATE TABLE "hr_commission_config" (
	...
	"personal_kpi_threshold_sen" integer DEFAULT 10000000 NOT NULL,
	"personal_kpi_bonus_bps" integer DEFAULT 50 NOT NULL,
	"showroom_kpi_threshold_sen" integer DEFAULT 40000000 NOT NULL,
...
CREATE TABLE "hr_item_kpi" (
	...
	"bonus_sen" integer DEFAULT 0 NOT NULL,
	"active" boolean DEFAULT true NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
);
...
CREATE TABLE "mfg_sales_order_items" (
	...
	"total_sen" integer DEFAULT 0 NOT NULL,
	"tax_sen" integer DEFAULT 0 NOT NULL,
	"total_inc_sen" integer DEFAULT 0 NOT NULL,
	...
	"variants" jsonb,
	"unit_cost_sen" integer DEFAULT 0 NOT NULL,
	"line_cost_sen" integer DEFAULT 0 NOT NULL,
	"line_margin_sen" integer DEFAULT 0 NOT NULL,
	"gap_inches" integer,
	"divan_height_inches" integer,
	"divan_price_sen" integer DEFAULT 0 NOT NULL,
	"leg_height_inches" integer,
...
CREATE TABLE "mfg_sales_orders" (
	...
	"address4" text,
	"phone" text,
	"mattress_sofa_sen" integer DEFAULT 0 NOT NULL,
	"bedframe_sen" integer DEFAULT 0 NOT NULL,
	"accessories_sen" integer DEFAULT 0 NOT NULL,
	"others_sen" integer DEFAULT 0 NOT NULL,
	"mattress_sofa_cost_sen" integer DEFAULT 0 NOT NULL,
	"bedframe_cost_sen" integer DEFAULT 0 NOT NULL,
	"accessories_cost_sen" integer DEFAULT 0 NOT NULL,
	"others_cost_sen" integer DEFAULT 0 NOT NULL,
	"service_sen" integer DEFAULT 0 NOT NULL,
	"service_cost_sen" integer DEFAULT 0 NOT NULL,
	"local_total_sen" integer DEFAULT 0 NOT NULL,
	"balance_sen" integer DEFAULT 0 NOT NULL,
	"total_cost_sen" integer DEFAULT 0 NOT NULL,
	"total_revenue_sen" integer DEFAULT 0 NOT NULL,
	"total_margin_sen" integer DEFAULT 0 NOT NULL,
	"margin_pct_basis" integer DEFAULT 0 NOT NULL,
	"line_count" integer DEFAULT 0 NOT NULL,
	"fabric_tier_addon_sen" integer DEFAULT 0 NOT NULL,
	...
	"paid_sen" integer DEFAULT 0 NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"created_by" uuid,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
);
...
CREATE TABLE "purchase_return_items" (
	...
	"qty_returned" integer NOT NULL,
	"unit_price_sen" integer DEFAULT 0 NOT NULL,
	"line_refund_sen" integer DEFAULT 0 NOT NULL,
	"reason" text,
	"notes" text,
	"gap_inches" integer,
	"divan_height_inches" integer,
