...
- [ ] **A2 Product & Maintenance 指导价**:1012 个 SKU 填 base 成本(只填 0,含 71 个从分页反查的)+ 73 个床架 price1(Fab2)
- [ ] **A3 开 compartment**:50 个 model 开 236 个件、铸 234 个 SKU;**每个 SKU 同步建 supplier binding 420 条(带那家报价矩阵)——“supplier 那边也会有吗”:会**
- [ ] **A4 沙发成本**:261 个 SKU 写基准价 477 格(每件一个价,面料档**不导**,升级钱走 fabric tier addon 那套)
...
### C1 拆件确认(15 行 — 原表是整件报价,按你的规则要拆)

| 表上写 | 家 | model | 价 | 我建议拆成 | 勾 |
|---|---|---|---|---|---|
| `2RR` | TD | 5071 | RM950 | 1A(R)(LHF) + 1A(R)(RHF) | ☐ |
| `2RR` | TD | 5071 | RM1000 | 1A(R)(LHF) + 1A(R)(RHF) | ☐ |
| `2RR` | TD | 5083 | RM950 | 1A(R)(LHF) + 1A(R)(RHF) | ☐ |
| `2RR` | TD | 5083 | RM1000 | 1A(R)(LHF) + 1A(R)(RHF) | ☐ |
| `2.5S` | TD | 5117A | RM1408 | ? | ☐ |
| `2.5` | THL | 7179 | RM1250 | ? | ☐ |
| `2.5` | THL | 7218 | RM1360 | ? | ☐ |
| `2.5` | THL | 7219 | RM1140 | ? | ☐ |
| `2.5 SEATER` | DSL | 8030 | RM2200 | ? | ☐ |
| `2.5 SEATER` | DSL | 8030 | RM2200 | ? | ☐ |
| `3NA` | DSL | 8060 | RM1800 | ? | ☐ |
| `2RR` | TD | BS22 | RM1320 | 1A(R)(LHF) + 1A(R)(RHF) | ☐ |
| `3RR` | TD | BS22 | RM1760 | 1A(R) + 2A | ☐ |
| `2RR` | TD | BS30 | RM1320 | 1A(R)(LHF) + 1A(R)(RHF) | ☐ |
| `3RR` | TD | BS30 | RM1760 | 1A(R) + 2A | ☐ |

拆开后单件价格表上没有——要么问厂,要么你给拆价规则(对半?)。

### C2 低置信度翻译(120 行没导,样例)
...
- 366 个 SKU 全工作簿无成本(多是 DEMO/停产);20 个无 supplier;63 个新开件表上没价
- 面料升级差价 1570 格已留档(A/Luxury/Premium/皮价等);套装 538 行、加购件 42 行、看不懂 77 行 —— 都在 report JSON,第二批处理
