...
- [ ] **A3 开 compartment**:51 个 model 开 225 个件、铸 223 个 SKU;**每个 SKU 同步建 supplier binding 396 条(带那家报价矩阵)——“supplier 那边也会有吗”:会**
- [ ] **A4 沙发成本**:265 个 SKU 写基准价 1523 格(每件一个价,面料档**不导**,升级钱走 fabric tier addon 那套)
...
| `2.5 SEATER` | DSL | 8030 | RM2288 | ? | ☐ |
| `2.5 SEATER` | DSL | 8030 | RM2376 | ? | ☐ |
