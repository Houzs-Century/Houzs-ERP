...
export const PERMISSIONS: PermissionDef[] = [
  ...
  { key: "scm.amendment.approve_lines",    resource: "Supply Chain", verb: "manage", label: "Approve SO amendment — product lines", description: "Approve (or reject) the PRODUCT-LINE lane of an SO amendment: SKU/spec, colour/fabric, quantity, added/removed lines, and price (except a 2990 price-only change, which is the price lane — see approve_price). Approving applies the SO revision at once and auto-raises the follow-up PO Amendment for purchasing to confirm" },
  ...
  { key: "scm.amendment.approve_price",    resource: "Supply Chain", verb: "manage", label: "Approve SO amendment — price (2990)", description: "Approve (or reject) the PRICE lane of a 2990 SO amendment: a price-only line change (unit price / discount; SKU, colour and quantity unchanged). Applies the SO revision at once; never touches a Purchase Order. HOUZS price changes stay on the product-lines lane" },
