...
import {
  ...
  AC_ADDRESS_LINES,
  fitAddressLines,
} from './autocount-address-fit';

/* RE-EXPORTED so every existing caller and test keeps one import site. The
   widths and the packing live in their own module because this file is at its
   size ceiling and the ceiling only ever moves down (docs/repo-hygiene.md). */
export { AC_ADDRESS_LINE_MAX, AC_ADDRESS_LINES, fitAddressLines };
