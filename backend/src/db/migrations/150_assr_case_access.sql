-- 150_assr_case_access.sql
--
-- D1 / TEST-MIRROR twin of migrations-pg/0284_assr_case_access.sql.
--
...
-- in lock-step with 0284; see docs/modules/service-case.md section 6.
--
