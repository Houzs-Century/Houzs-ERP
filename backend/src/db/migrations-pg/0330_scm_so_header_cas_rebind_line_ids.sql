-- 0330_scm_so_header_cas_rebind_line_ids.sql (Postgres)
...
CREATE OR REPLACE FUNCTION scm.apply_so_header_cas(
  ...
  -- 0330 — line ids the ROUTE has verified safe to move (bound to another
  ...
  -- NULL = only NULL-warehouse lines rebind (the pre-0330 behaviour).
