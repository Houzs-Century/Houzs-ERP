...
test("FromSODtlKey reads as absent when AutoCount stores 0 or nothing", () => {
  ...
  // re-cut. 2026-09-07 FINAL cut, taken 17:17:55 in a quiet window after
  // AutoCount was locked view-only: 956 merged lines carrying 697 with an SO origin. Earlier
