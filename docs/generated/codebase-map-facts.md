...
| `backend/src/scm/routes/delivery-order-exports.ts` | 1 | 49 |
...
Top 20 by line count across `backend/src` and `frontend/src` (2562 files, 807282 lines total).
