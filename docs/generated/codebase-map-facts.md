...
| `backend/src/db/migrations-pg` | `backend/scripts/pg-migrate.mjs` | 327 | `0329_scm_trip_public_scan_token.sql` (0329) | YES | no |
...
Top 20 by line count across `backend/src` and `frontend/src` (1752 files, 638744 lines total).
