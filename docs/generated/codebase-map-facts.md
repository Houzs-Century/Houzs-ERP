...
127 route modules (41 in `backend/src/routes`, 86 in `backend/src/scm/routes`), 1012 endpoint registrations.
...
| `backend/src/scm/routes/mfg-sales-orders.ts` | 42 | 11924 |
...
Top 20 by line count across `backend/src` and `frontend/src` (1457 files, 580717 lines total).
Read these by line range, never whole — see the CODEBASE-MAP section of the same name.

| file | lines |
|---|---|
| `frontend/src/pages/Projects.tsx` | 15128 |
| `backend/src/scm/routes/mfg-sales-orders.ts` | 11924 |
