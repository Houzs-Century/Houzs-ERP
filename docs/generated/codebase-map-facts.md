...
| `backend/src/db/migrations-pg` | `backend/scripts/pg-migrate.mjs` | 309 | `0311_scm_so_mirror_skips.sql` (0311) | YES | no |
...
Top 20 by line count across `backend/src` and `frontend/src` (1498 files, 588264 lines total).
