...
| `backend/src/routes/assr_print.ts` | 1 | 1247 |
...
| `backend/src/routes/systemHealth.ts` | 6 | 420 |
...
| `backend/src/scm/routes/consignment-orders.ts` | 19 | 2510 |
...
| `backend/src/scm/routes/grns.ts` | 13 | 3785 |
...
| `backend/src/scm/routes/mfg-sales-orders.ts` | 42 | 12157 |
...
| `backend/src/scm/routes/so-amendments.ts` | 9 | 1215 |
...
| `backend/src/db/migrations-pg` | `backend/scripts/pg-migrate.mjs` | 291 | `0291_scm_return_do_units_at_cost.sql` (0291) | YES | no |
...
Top 20 by line count across `backend/src` and `frontend/src` (1289 files, 538470 lines total).
Read these by line range, never whole — see the CODEBASE-MAP section of the same name.

| file | lines |
|---|---|
| `frontend/src/pages/Projects.tsx` | 14875 |
| `backend/src/scm/routes/mfg-sales-orders.ts` | 12157 |
...
| `backend/src/scm/routes/grns.ts` | 3785 |
