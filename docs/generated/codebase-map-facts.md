...
| `backend/src/db/migrations-pg` | `backend/scripts/pg-migrate.mjs` | 300 | `0302_scm_si_items_do_item_id.sql` (0302) | YES | no |
...
Top 20 by line count across `backend/src` and `frontend/src` (1446 files, 577838 lines total).
