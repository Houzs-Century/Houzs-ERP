...
| `backend/src/scm/routes/accounting-bank.ts` | 0 | 1186 |
...
| `backend/src/scm/routes/accounting.ts` | 88 | 1548 |
...
Top 20 by line count across `backend/src` and `frontend/src` (2180 files, 746667 lines total).
