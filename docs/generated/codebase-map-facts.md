...
199 route modules (53 in `backend/src/routes`, 146 in `backend/src/scm/routes`), 1305 endpoint registrations.
...
Top 20 by line count across `backend/src` and `frontend/src` (2521 files, 801152 lines total).
