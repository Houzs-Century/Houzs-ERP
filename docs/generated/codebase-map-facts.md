...
| `backend/src/db/migrations-pg` | `backend/scripts/pg-migrate.mjs` | 343 | `0344_acc_autocount_code_migration.sql` (0344) | YES | no |
...
Top 20 by line count across `backend/src` and `frontend/src` (1863 files, 670226 lines total).
