...
176 route modules (49 in `backend/src/routes`, 127 in `backend/src/scm/routes`), 1223 endpoint registrations.
...
Top 20 by line count across `backend/src` and `frontend/src` (2055 files, 715008 lines total).
