...
177 route modules (49 in `backend/src/routes`, 128 in `backend/src/scm/routes`), 1225 endpoint registrations.
...
Top 20 by line count across `backend/src` and `frontend/src` (2059 files, 716648 lines total).
