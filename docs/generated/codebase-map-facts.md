...
| `backend/src/scm/routes/mfg-sales-orders.ts` | 42 | 12065 |
...
Top 20 by line count across `backend/src` and `frontend/src` (1446 files, 577793 lines total).
Read these by line range, never whole — see the CODEBASE-MAP section of the same name.

| file | lines |
|---|---|
| `frontend/src/pages/Projects.tsx` | 15138 |
| `backend/src/scm/routes/mfg-sales-orders.ts` | 12065 |
