...
| `backend/src/scm/routes/accounting-receipts.ts` | 0 | 89 |
...
| `backend/src/scm/routes/accounting.ts` | 101 | 1588 |
...
| `backend/src/scm/routes/mfg-products.ts` | 12 | 1330 |
...
| `backend/src/scm/routes/suppliers.ts` | 12 | 1147 |
