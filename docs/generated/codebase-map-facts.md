...
| `backend/src/db/migrations-pg` | `backend/scripts/pg-migrate.mjs` | 370 | `0352_acc_pv_files.sql` (0352) | YES | no |
...
Top 20 by line count across `backend/src` and `frontend/src` (1994 files, 700910 lines total).
