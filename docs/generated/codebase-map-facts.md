...
137 route modules (41 in `backend/src/routes`, 96 in `backend/src/scm/routes`), 1050 endpoint registrations.
...
Top 20 by line count across `backend/src` and `frontend/src` (1492 files, 586598 lines total).
