...
| `backend/src/routes/projects.ts` | 109 | 5345 |
...
Top 20 by line count across `backend/src` and `frontend/src` (1310 files, 543422 lines total).
...
| `backend/src/routes/projects.ts` | 5345 |
