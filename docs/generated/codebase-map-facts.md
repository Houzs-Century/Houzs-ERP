...
| `backend/src/routes/assr.ts` | 62 | 3368 |
...
Top 20 by line count across `backend/src` and `frontend/src` (1541 files, 595457 lines total).
...
| `backend/src/routes/assr.ts` | 3368 |
