...
141 route modules (42 in `backend/src/routes`, 99 in `backend/src/scm/routes`), 1056 endpoint registrations.
...
Top 20 by line count across `backend/src` and `frontend/src` (1621 files, 610306 lines total).
