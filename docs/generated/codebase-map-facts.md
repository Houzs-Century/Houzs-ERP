...
| `backend/src/scm/routes/consignment-orders.ts` | 19 | 2405 |
...
| `backend/src/db/migrations-pg` | `backend/scripts/pg-migrate.mjs` | 285 | `0286_scm_processing_date_one_name.sql` (0286) | YES | no |
...
Top 20 by line count across `backend/src` and `frontend/src` (1282 files, 533299 lines total).
