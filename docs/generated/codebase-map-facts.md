...
| `backend/src/scm/routes/mfg-sales-orders.ts` | 42 | 12001 |
...
Top 20 by line count across `backend/src` and `frontend/src` (1399 files, 565539 lines total).
Read these by line range, never whole — see the CODEBASE-MAP section of the same name.

| file | lines |
|---|---|
| `frontend/src/pages/Projects.tsx` | 15128 |
| `backend/src/scm/routes/mfg-sales-orders.ts` | 12001 |
