...
| `backend/src/db/migrations-pg` | `backend/scripts/pg-migrate.mjs` | 346 | `0347_acc_chart_manage.sql` (0347) | YES | no |
...
Top 20 by line count across `backend/src` and `frontend/src` (1879 files, 674002 lines total).
