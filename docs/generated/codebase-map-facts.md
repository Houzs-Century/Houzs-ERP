...
174 route modules (47 in `backend/src/routes`, 127 in `backend/src/scm/routes`), 1215 endpoint registrations.
...
Top 20 by line count across `backend/src` and `frontend/src` (2049 files, 714709 lines total).
