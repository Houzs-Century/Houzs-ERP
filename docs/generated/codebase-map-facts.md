...
202 route modules (53 in `backend/src/routes`, 149 in `backend/src/scm/routes`), 1308 endpoint registrations.
...
Top 20 by line count across `backend/src` and `frontend/src` (2580 files, 811298 lines total).
