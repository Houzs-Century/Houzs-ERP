...
| `backend/src/scm/routes/so-amendments.ts` | 11 | 1556 |
...
Top 20 by line count across `backend/src` and `frontend/src` (2762 files, 830153 lines total).
