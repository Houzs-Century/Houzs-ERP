...
208 route modules (54 in `backend/src/routes`, 154 in `backend/src/scm/routes`), 1312 endpoint registrations.
...
| `backend/src/scm/routes/accounting-receipts-backfill.ts` | 0 | 230 |
| `backend/src/scm/routes/accounting-receipts.ts` | 0 | 88 |
| `backend/src/scm/routes/accounting-report-layouts.ts` | 0 | 205 |
| `backend/src/scm/routes/accounting-reports.ts` | 0 | 237 |
...
| `backend/src/scm/routes/accounting.ts` | 101 | 1585 |
...
| `backend/src/scm/routes/inventory.ts` | 17 | 1773 |
...
| `backend/src/scm/routes/mfg-products.ts` | 11 | 1296 |
...
| `backend/src/scm/routes/mfg-sales-orders.ts` | 45 | 11474 |
...
| `backend/src/scm/routes/payment-vouchers.ts` | 21 | 1997 |
...
| `backend/src/scm/routes/suppliers.ts` | 12 | 1058 |
...
| `backend/src/db/migrations-pg` | `backend/scripts/pg-migrate.mjs` | 432 | `0352_acc_pv_files.sql` (0352) | YES | no |
...
Top 20 by line count across `backend/src` and `frontend/src` (2662 files, 820742 lines total).
Read these by line range, never whole — see the CODEBASE-MAP section of the same name.

| file | lines |
|---|---|
| `frontend/src/pages/Projects.tsx` | 15144 |
| `backend/src/scm/routes/mfg-sales-orders.ts` | 11474 |
...
| `frontend/src/mobile/MobileNewSO.tsx` | 3714 |
...
162 `<Route>` declarations in `frontend/src/App.tsx` (aliases from
...
| `/scm/credit-notes` | `frontend/src/pages/scm-v2/CreditNotes` |
...
| `/scm/fair-pending` | `frontend/src/pages/scm-v2/FairPending` |
...
| `/scm/receipts` | `frontend/src/pages/scm-v2/Receipts` |
...
| `frontend/src/mobile/MobileAmendments.tsx` | 174 |
...
| `frontend/src/mobile/MobileLinePoRef.tsx` | 87 |
| `frontend/src/mobile/MobileLineRemark.tsx` | 38 |
...
| `frontend/src/mobile/MobileModuleDetail.tsx` | 1960 |
...
| `frontend/src/mobile/MobileNewSO.tsx` | 3714 |
| `frontend/src/mobile/MobileOrderMoney.tsx` | 75 |
| `frontend/src/mobile/MobilePMS.tsx` | 4490 |
...
| `/scm/warehouses/racks` | Racks | `frontend/src/pages/scm-v2/WarehouseRacks` | dedicated: racks |
