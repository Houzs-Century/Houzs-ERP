...
183 route modules (51 in `backend/src/routes`, 132 in `backend/src/scm/routes`), 1251 endpoint registrations.
...
| `backend/src/scm/routes/accounting-bank-locks.ts` | 0 | 225 |
| `backend/src/scm/routes/accounting-bank-months.ts` | 0 | 501 |
| `backend/src/scm/routes/accounting-bank.ts` | 0 | 1131 |
...
| `backend/src/scm/routes/accounting.ts` | 87 | 1546 |
...
| `backend/src/scm/routes/mfg-purchase-orders.ts` | 24 | 4519 |
...
| `backend/src/db/migrations-pg` | `backend/scripts/pg-migrate.mjs` | 402 | `0352_acc_pv_files.sql` (0352) | YES | no |
...
Top 20 by line count across `backend/src` and `frontend/src` (2171 files, 744139 lines total).
