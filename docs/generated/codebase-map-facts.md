...
148 route modules (44 in `backend/src/routes`, 104 in `backend/src/scm/routes`), 1069 endpoint registrations.
...
Top 20 by line count across `backend/src` and `frontend/src` (1761 files, 640257 lines total).
