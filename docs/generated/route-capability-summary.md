...
- Total route rows: 1169
- Routes with a declared capability/area gate: 1030
- Mutation routes requiring manual capability classification: 76
- Read routes requiring manual capability classification: 63
- Routes with no static authentication gate: 25
