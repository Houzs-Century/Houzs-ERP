...
| `edit` | `/edit` | yes | delivery-orders-mfg.ts x5, grns.ts x4, mfg-purchase-orders.ts x7, mfg-sales-orders.ts x11, po-amendments.ts x1, purchase-invoices.ts x5, sales-invoices.ts x6, so-amendments.ts x1, so-handover.ts x1, lib/ac-grn-outbox.ts x2, lib/ac-so-payment-edit.ts x1 | no |
