...
// v169 (2026-07-14) — service-case mobile redesign: tabbed detail
...
//   to be relied on for is already guaranteed by msbzrsqp below; the
//   bump is documentation, and it does clear any already-poisoned entry.
// Auto-versioned per deploy: the build replaces the msbzrsqp token below
...
const VERSION = "houzs-erp-v191-msbzrsqp";
