/* The Credit & Debit Notes page (docs/bugs/0827): the list with kind and
   ...
   note opens to its lines and posts or cancels. The server half is
   backend/tests/creditNotes.test.ts. */
...
vi.mock('../../vendor/scm/lib/credit-note-queries', async (importOriginal) => ({
  ...
  useCreditNoteDetail: (id: string | null) => ({
    data: id ? { note: NOTES.find((n) => n.id === id)!, lines: [{ id: 'l1', line_no: 1, description: 'Scratched leg — goodwill', account_code: '510-0000', amount_sen: 15000 }] } : undefined,
    isLoading: false,
  }),
