...
/* 16px twins of the tile icons, for the source menu's rows. */
const CAMERA_SM = (
...
/* The dark chip overlaid on an already-taken front slip (Replace). */
                    ...
                    {!submitting && (
                      <>
                        ...
                        <button
                          ...
                          style={{ ...RESHOOT_CHIP, position: "absolute", bottom: 6, right: 6 }}
                        >
                          Replace
                        </button>
                      </>
