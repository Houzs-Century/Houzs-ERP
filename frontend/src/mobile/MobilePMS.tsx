  ...
  const defectActionsValue = useMemo(
    () => ({
      ...
      canReview: (() => {
        ...
        // The reviewer POSITION is the Title's Duty/profile on the server
        // (org.defect.reviewer); the name regex is the fallback for a shell
        // whose /auth/me predates the capability set.
        const isShukor = user.capabilities
          ? user.capabilities["org.defect.reviewer"] === true
