...
// integer *_sen (sen, 1/100 of a currency unit), matching 2990's convention.
 ...
 *  For callers that print their own "RM " prefix; {@link fmtSen} builds on it
...
/** Format an integer *_sen value into a display string, e.g. 123456 → "RM 1,234.56".
 *  NOTE: this is NOT the same function as `fmtSen` in vendor/shared/format.ts —
...
export function fmtSen(centi: number | null | undefined, currency = "MYR"): string {
