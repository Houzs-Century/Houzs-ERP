    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { to: "/scm/cancel-requests", label: "Cancellation Requests", icon: Ban, anyPerm: ["*", "scm.access", "scm.so_cancel.approve_l1", "scm.so_cancel.approve_l2", "scm.po_cancel.approve_l1", "scm.po_cancel.approve_l2"], anyAccess: ["scm.procurement.po", "scm.sales.orders"], hideForSalesRep: true },
