  ...
  return (
    <div className="space-y-3 rounded-lg border border-border bg-surface p-3">
      <div className="flex items-start justify-between gap-3">
        <div>
          <div className="text-[12px] font-semibold text-ink">Check what was read</div>
          <div className="text-[11px] text-ink-muted">Every field is editable. Nothing is saved until you confirm.</div>
        </div>
        ...
        <table className="w-full min-w-[860px] text-[11.5px]">
          <thead>
            <tr className="bg-surface-2/50 text-left text-[10px] uppercase tracking-brand text-ink-muted">
              <th className="px-2 py-1.5 font-semibold">Keep</th>
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <Button variant="secondary" onClick={() => { setRes(null); setRows([]); setErr(null); }} disabled={saving}>
